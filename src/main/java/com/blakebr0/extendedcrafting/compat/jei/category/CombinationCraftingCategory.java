...
public class CombinationCraftingCategory implements IRecipeCategory<ICombinationRecipe> {
	private static final ResourceLocation TEXTURE = new ResourceLocation(ExtendedCrafting.MODID, "textures/jei/combination_crafting.png");
	public static final RecipeType<ICombinationRecipe> RECIPE_TYPE = RecipeType.create(ExtendedCrafting.MODID, "combination", ICombinationRecipe.class);
