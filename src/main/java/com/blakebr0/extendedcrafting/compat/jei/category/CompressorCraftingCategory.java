...
public class CompressorCraftingCategory implements IRecipeCategory<ICompressorRecipe> {
	private static final ResourceLocation TEXTURE = new ResourceLocation(ExtendedCrafting.MODID, "textures/jei/compressor.png");
	public static final RecipeType<ICompressorRecipe> RECIPE_TYPE = RecipeType.create(ExtendedCrafting.MODID, "compressor", ICompressorRecipe.class);
